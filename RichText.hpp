...
public:
    ...
    public:
        ...
        //////////////////////////////////////////////////////////////////////
        // Set a character's outline color.
        // NOTE: Attempting to access a character outside of the line bounds
        // causes a crash.
        //////////////////////////////////////////////////////////////////////
        void setCharacterOutlineColor(std::size_t pos, sf::Color color);

        //////////////////////////////////////////////////////////////////////
        // Set a character's autline thickness.
        // NOTE: Attempting to access a character outside of the line bounds
        // causes a crash.
        //////////////////////////////////////////////////////////////////////
        void setCharacterOutlineThickness(std::size_t pos, float thickness);
        ...
        //////////////////////////////////////////////////////////////////////
        // Get a character's outline color
        // NOTE: Attempting to access a character outside of the line bounds
        // causes a crash.
        //////////////////////////////////////////////////////////////////////
        sf::Color getCharacterOutlineColor(std::size_t pos) const;

        //////////////////////////////////////////////////////////////////////
        // Get a character's outline thickness
        // NOTE: Attempting to access a character outside of the line bounds
        // causes a crash.
        //////////////////////////////////////////////////////////////////////
        float getCharacterOutlineThickness(std::size_t pos) const;
    ...
    private:
        ...
        //////////////////////////////////////////////////////////////////////
        void updateTextAndGeometry(sf::Text &text, float spacing = 0) const;
    ...
    //////////////////////////////////////////////////////////////////////////
    // Nested struct used to enter the outline color to the operator <<
    //////////////////////////////////////////////////////////////////////////
    struct OutlineColor
    {
        sf::Color color;
    ...
    //////////////////////////////////////////////////////////////////////////
    // Nested struct used to enter the outline thickness to the operator <<
    //////////////////////////////////////////////////////////////////////////
    struct OutlineThickness
    {
        float thickness;
    };
    ...
    RichText & operator << (const OutlineColor &outlineColor);
    RichText & operator << (const OutlineThickness &outlineThickness);
    ...
    //////////////////////////////////////////////////////////////////////////
    // Set the outline color of a character.
    // Attempting to access a character outside of the bounds causes a crash.
    //////////////////////////////////////////////////////////////////////////
    void setCharacterOutlineColor(std::size_t line, std::size_t pos, sf::Color color);

    //////////////////////////////////////////////////////////////////////////
    // Set the outline tickness of a character.
    // Attempting to access a character outside of the bounds causes a crash.
    //////////////////////////////////////////////////////////////////////////
    void setCharacterOutlineThickness(std::size_t line, std::size_t pos, float thickness);
    ...
    //////////////////////////////////////////////////////////////////////////
    // Get the outline color of a character.
    // Attempting to access a character outside of the bounds causes a crash.
    //////////////////////////////////////////////////////////////////////////
    sf::Color getCharacterOutlineColor(std::size_t line, std::size_t pos) const;

    //////////////////////////////////////////////////////////////////////////
    // Get the outline thickness of a character.
    // Attempting to access a character outside of the bounds causes a crash.
    //////////////////////////////////////////////////////////////////////////
    float getCharacterOutlineThickness(std::size_t line, std::size_t pos) const;
...
private:
    ...
    sf::Color m_currentOutlineColor;   ///< Last outline color used
    float m_currentOutlineThickness;   ///< Last outline thickness used
